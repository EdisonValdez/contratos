...
<title>CONTRATO DE MEMBRESIA</title>
</head>
...
<center><p><strong>MEMBERSHIP CONTRACT </strong><br />
...
<table width="100%">
<tr>                                                 
<td width="35%"><p><?php echo $client1; echo $client1 ?>&nbsp; </p></td>
<td width="15%">NATIONALITY: </td><td width="20%"><?php echo $nationality1; ?></td></tr>
  PASSPORT NO: <?php echo $passport1; ?>&nbsp;          CIVIL STATUS:  <?php echo $civil_status1; ?>&nbsp;  </p>
<p>ADDRESS:  <?php echo $address1; ?>&nbsp;  </p>
<p>CITY: <?php echo $city1; ?>&nbsp;     STATE/PROVINCE: <?php echo $state1; ?>&nbsp;   <br />
  COUNTRY: <?php echo $country1; ?>&nbsp;  </p>
<p>HOME PHONE: <?php echo $home_phone1; ?>&nbsp;   WORK PHONE: <?php echo $work_phone1; ?>&nbsp;   <br />
  FAX: <?php echo $fax1; ?>&nbsp;     E-MAIL:<?php echo $email1; ?>&nbsp;  </p>
<p>&nbsp;</p>
...
<p><strong>SEVEN:</strong> <strong>DURATION</strong><br />
  Unless the current Contract is terminated as specifically indicated in  its own terms, it shall be terminated following a term of <?php $term_of_year_letter; ?> (&nbsp;<?php $term_of_year_number; ?>&nbsp; ) years from the date of execution hereof;  therefore, upon termination of this Agreement the CLIENT expressly recognizes  that  Membership&rsquo;s rights and benefits  shall be terminated..</p>
...
<p>&nbsp;</p>
<p>THE CLIENT                                                     IBEROCLUB N.V.     </p>
<p>Signature______________________                          Signature____________________          </p>
<p>Mr./Ms. _________________________                      Mr. Raul Ojeda  </p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<br clear="all" />
...
<p>____/____ The consideration  for the membership type <?php echo $membership_type; ?> is <?php echo $price;?>&nbsp;USD.<br />
  ...
  ____/____ Each  year within the term of the membership, THE CLIENT shall have the right to book  a maximum number of <?php echo $interval_exchange*7; ?> nights in order to make a maximum number of  <?php echo $term_of_year_number/7;?>&nbsp;exchange intervals of 7 nights. For the exchange it is necessary to  cover the transaction rate of <?php echo $rci_transaction_rate;?> US dollars. <br />
...
<p>&nbsp;</p>
<p>Membership  No. <?php echo  $membership_number; ?>     <br />
  THE CLIENT                                                     IBEROCLUB N.V.     </p>
<p>Signature______________________                          Signature____________________          </p>
<p>Mr./Ms. <?php echo  $client1; ?>                       Mr. Raul Ojeda  </p>
