...
<body style="margin:50px; margin-top:20px; text-align:justify;">
...
<p align="center"><strong><u>ANNEX II</u></strong><strong><u> </u></strong><br />
  ...
  <strong><u>PROMISSORY NOTE</u></strong> </p><br />
...
$username = "bullatic_Edison";

$password = "The_secret_1";

$dbname = "bullatic_contratos";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo " <p><strong style='align:right;'> MEMBERSHIP # <u>" . $row['membership_number'] ."</u></strong></p>
...
<th width='50%'>THE CLIENT</th></tr>

<tr>

<td width='50%'>Signature______________________</td><td width='50%'>Signature______________________</td>

  </tr>

<tr>

<td width='50%'>Mr./Ms.".$row['client1'] ."</td><td width='50%'>Mr./Ms. ".$row['client2'] ."</td></tr>
