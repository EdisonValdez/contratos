...
if (!$conn) {
    ...
    die("Connection failed: " . mysqli_connect_error());
					 ...
					 @$pending_payment_via  = htmlentities(strtoupper($_POST["pending_payment_via"],ENT_QUOTES,"UTF-8")); 
					...
					$date_of_payment1 = date('Y-m-d', strtotime($_POST['date_of_payment1']));
					...
					@$date_of_payment2 = date('Y-m-d', strtotime($_POST['date_of_payment2']));
					//@ = $client1; 

					@$client1 = htmlentities(strtoupper($_POST["client1"],ENT_QUOTES,"UTF-8" ));	

					@$client2 = htmlentities(strtoupper($_POST["client2"],ENT_QUOTES,"UTF-8" ));	
