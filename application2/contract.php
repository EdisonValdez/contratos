...
<?php
		...
		//if($_POST["pending_payment2_via"] = ''){	$pending_payment2_via = $pending_payment2_via;}
		...
		$term_of_year_letter = htmlentities($_POST["term_of_year_letter"],ENT_QUOTES,"UTF-8" );
 		//$years_of_membership_letters = htmlentities($_POST["years_of_membership_letters"],ENT_QUOTES,"UTF-8" );
		...
		//$has_lloyd_share = htmlentities($_POST["has_lloyd_share"],ENT_QUOTES,"UTF-8");
